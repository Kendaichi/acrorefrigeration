  ...
  <Layout>
    <div className="container-narrow section-padding">
      ...
      <div className="prose prose-lg max-w-none space-y-8 text-foreground/80">
        <section>
          <p>
            Acro Refrigeration is Brisbane and South-East Queensland's trusted
            commercial refrigeration specialist, providing 24/7 emergency
            ...
            responsibly and transparently. This Privacy Policy explains how Acro
        ...
        <section>
          ...
          <p>
            Acro Refrigeration ("we", "us", "our") is committed to protecting
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              Provide, schedule, and manage commercial refrigeration and cold
              room services
            </li>
        ...
        <section>
          ...
          <ul className="list-none space-y-1">
            ...
            <li>
              <strong>Email:</strong> admin@acrorefrigeration.com.au
            </li>
            <li>

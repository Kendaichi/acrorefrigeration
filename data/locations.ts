...
export const cities: CityData[] = [
  {
    slug: "brisbane",
    name: "Brisbane",
    regionDescription: "South-East Queensland's capital — from CBD high-rises to suburban shopping centres, we keep Brisbane's cold chains running 24/7.",
    stats: [
  ...
  },
  {
    slug: "gold-coast",
    name: "Gold Coast",
    regionDescription: "From Surfers Paradise to Coolangatta — fast emergency repairs and maintenance for the Coast's booming hospitality industry.",
    stats: [
  ...
  },
  {
    slug: "sunshine-coast",
    name: "Sunshine Coast",
    regionDescription: "Noosa to Caloundra — expert refrigeration maintenance and emergency repairs for the Sunshine Coast's growing food and hospitality sector.",
    stats: [
      { label: "Avg Response", value: "2 hrs" },

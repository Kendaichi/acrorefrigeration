...
export const projects: Project[] = [
  {
    ...
    solution:
      "Acro Refrigeration implemented a structured preventative maintenance program with quarterly site visits, 24/7 remote monitoring, and centralised compliance reporting. Each store received a full system audit before the program commenced.",
    outcomes: [
  ...
  },
  {
    ...
    solution:
      "Acro dispatched a technician within 20 minutes of the call. On arrival, the technician diagnosed a seized compressor motor and sourced a replacement from our emergency parts stock. The system was restored and temperature-stable before 5:30am.",
    outcomes: [
  ...
  },
  {
    ...
    solution:
      "Acro's in-house design and construction team engineered a modular blast freezer system incorporating redundant compressors, positive-pressure airlocks, and a custom drainage design to meet HACCP requirements. Construction was staged to minimise operational downtime on the existing facility.",
    outcomes: [
  ...
  },
  {
    ...
    solution:
      "We resolved the emergency condenser failure within four hours, then conducted a full facility audit. Following the audit, ColdChain engaged Acro for a preventative maintenance contract across both their Gold Coast and Brisbane facilities, including quarterly servicing and remote monitoring.",
    outcomes: [

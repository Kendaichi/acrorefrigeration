...
export const termsContent = {
  ...
  intro:
    "These Terms & Conditions apply to all quotations, work orders, service calls, repairs, maintenance, and installations performed by HVACR Pty Ltd trading as ACRO Refrigeration and Shelair Group.",
  effectiveDate: "1 January 2026",
  company: "HVACR Pty Ltd trading as ACRO Refrigeration and Shelair Group",
  qbcc: "15413155",
  abn: "43 672 578 264",
  sections: [
    {
    ...
    },
    {
      heading: "29. Privacy",
      bodies: [
        "HVACR Pty Ltd collects and handles personal information in accordance with our Privacy Policy and the Privacy Act 1988 (Cth). For enquiries regarding your personal information, contact us at workshop@acrorefrigeration.com.au.",
      ],
    },
    {
    ...
    },
    {
      ...
      numberedItems: [
        ...
        { id: "A17", text: "Specific design recommendations — clients must obtain independent professional advice. Where HVACR Pty Ltd (trading as ACRO and Shelair) facilitates third-party drawings on the client's behalf, we bear no liability for their accuracy, suitability, or completeness." },

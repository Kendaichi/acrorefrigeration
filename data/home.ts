...
export const hero = {
  ...
  subheading:
    "Breakdowns don't wait — neither do we. Fast emergency repairs, preventative maintenance plans, and expert servicing for all commercial refrigeration systems.",
...
export const capabilitiesGrid = {
  heading: "Why Businesses Trust Acro",
  subheading:
...
export const testimonialsSection = {
  ...
  subheading: "See what our clients say about working with Acro Refrigeration.",
  testimonials: [
    {
      name: "Mark Thompson",
...
export const locationsSection = {
  badge: "Service Areas",
  heading: "Commercial Refrigeration Repairs Near You",
  subheading:

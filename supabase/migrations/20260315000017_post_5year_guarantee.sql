...
-- Source: https://acrorefrigeration.com.au/5-year-workmanship-guarantee/
...
with inserted as (
  ...
  (
    ...
    'ACRO Refrigeration backs every installation and repair with a 5-year workmanship guarantee — on top of any manufacturer''s warranty. Here''s what that means for your business.',
    'Jun 2025',
    '4 min read',
...
(
  ...
  array[
    'When you invest in commercial refrigeration or HVAC work, you expect it to last. So do we. While most contractors only offer coverage based on the manufacturer''s warranty on parts, Acro Refrigeration goes further — backing every installation and repair with our own 5-Year Workmanship Guarantee.',
...
(
  ...
  array[
    ...
    'All Acro Refrigeration technicians are fully licensed and work to Australian standards. Our work is documented with compliance paperwork after every job — giving you an audit trail that satisfies HACCP and TGA requirements, and a record that supports any future guarantee claim.'
  ],
  3
),
...
(
  ...
  array[
    ...
    'Our guarantee is designed for businesses where downtime has real consequences. It means that when your system is installed by Acro, you don''t just have a piece of equipment — you have five years of accountability behind the work that brought it to life.',

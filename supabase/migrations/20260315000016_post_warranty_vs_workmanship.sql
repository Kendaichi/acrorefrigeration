...
-- Source: https://acrorefrigeration.com.au/refrigeration-warranty-vs-workmanship-guarantee/
...
with inserted as (
  ...
  (
    ...
    'Learn the difference between a refrigeration manufacturer''s warranty and a workmanship guarantee. Acro Refrigeration backs every installation with a 5-year workmanship guarantee across SE Queensland.',
    'Jul 2025',
    '5 min read',
...
(
  ...
  array[
    'When investing in a commercial refrigeration system, understanding the difference between a manufacturer''s warranty and a workmanship guarantee is critical. These two protections cover very different things, and knowing what each covers can save your business time, money, and significant headaches if something goes wrong.',
    'At Acro Refrigeration, we back every installation and service job with a 5-year workmanship guarantee — giving our clients clarity and peace of mind that most contractors simply don''t offer.'
  ],
  0
),
...
-- 4 ── Acro Gives You Both
(
  (select id from inserted),
  'Acro Refrigeration Gives You Both',
  array[
    'We only use reputable, warranty-backed commercial refrigeration brands, and every project is delivered by our licensed technicians under our exclusive 5-year workmanship guarantee. Manufacturer warranties are honoured, workmanship is guaranteed, and you have full support for claims, diagnostics and repairs throughout — with transparent documentation for asset managers and compliance teams.',
...
(
  ...
  array[
    ...
    'How long do refrigeration warranties last? Most commercial refrigeration warranties last between 1 and 5 years depending on the brand and model. Some components like compressors may carry extended warranty periods. Always confirm the exact terms with your installer at time of purchase.',
